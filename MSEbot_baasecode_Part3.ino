   ...
   switch(CR1_ucMainTimerCaseCore1)  //full switch run through is 1mS
   {
    ...
    case 0: 
    {
      ...
      if(btRun)
      {
       ...
       if(CR1_ulMotorTimerNow - CR1_ulMotorTimerPrevious >= CR1_ciMotorRunTime && (!ENC_ISMotorRunning()))   
       {   
          x = 42.05;
         ...
         switch(ucMotorStateIndex)
         {
           ...
           case 1:
          {
            ...
            ENC_SetDistance(271.76, 271.76); // 100 = 11.22 inch and 11 inch = 98 ticks and 8.5 inch = 75.76 ticks.
            ucMotorState = 1;   //forward
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed-x-3.2125;
          ...
          case 3:
          {
            ENC_SetDistance(-22.5, 22.5);
            CR1_ui8LeftWheelSpeed = 170;
            CR1_ui8RightWheelSpeed = 170;
            ucMotorStateIndex = 4;
            ucMotorState = 2;  //left
            break;
          }
          ...
          case 5:
          {
            ...
            ucMotorState = 1;   //forward
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed-x-2.2;
            CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
            ucMotorStateIndex = 6;
            break;
          }
          ...
          case 17:
          {
            ...
            ucMotorState = 1;   //forward
            CR1_ui8LeftWheelSpeed = 182;
            CR1_ui8RightWheelSpeed = 190;
         ...
         case 18:
          ...
          case 19:
          {
            Serial.print(CR1_ui8IRDatum);
            if(CR1_ui8IRDatum == 65){
              ucMotorStateIndex = 20;
            }
            else{
              ucMotorState = 1;
              ENC_SetDistance(1, 1);
              CR1_ui8LeftWheelSpeed = 177;
              CR1_ui8RightWheelSpeed = 190;
