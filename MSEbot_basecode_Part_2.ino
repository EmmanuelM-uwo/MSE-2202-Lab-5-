...
void setup() {
  ...
  ledcAttachPin(15, 7); //servo on j30
  ledcSetup(7, 50, 16);
}
   ...
   switch(CR1_ucMainTimerCaseCore1)  //full switch run through is 1mS
   {
    ...
    case 0: 
    {
      ...
      if(btRun)
      {
       ...
       if(CR1_ulMotorTimerNow - CR1_ulMotorTimerPrevious >= (CR1_ciMotorRunTime * distanceCorrection))   
       {   
         ...
         switch(ucMotorStateIndex)
         {
          case 0:
          {
            ledcWrite(7, configureMotor(0));
            ucMotorStateIndex = 1;
            ucMotorState = 0;
            distanceCorrection = 2.4;
            move(0);
            break;
          }
           case 1:
          {
            ...
            ENC_SetDistance(274.28, 293.83);
            ucMotorState = 1;   //forward
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed-44-2;
          ...
          case 5:
          {
             ENC_SetDistance(150, 160.7);
            ucMotorState = 1;   //forward
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed-54;
            CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
            ucMotorStateIndex = 7;
            break;
          }
          ...
          case 6:
          {
            ENC_SetDistance(20.0, -20.0);
            CR1_ui8LeftWheelSpeed = 254;
            CR1_ui8RightWheelSpeed = 254;
            ucMotorStateIndex = 8;
          ...
          case 8:
          {
            ...
            ucMotorState = 1;   //forward
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed-30-1;
            CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
            ucMotorStateIndex = 9;
            break;
          }
          ...
          case 13:
          {
            ...
            ucMotorState = 0;
            distanceCorrection = 3.425;
            move(0);
            break;
          }
          case 14:
          {
            ENC_SetDistance(480, 480);
            ucMotorState = 1;   //forward
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed-47;
            CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
         ...
         case 15:
          ...
          {
            ENC_SetDistance(480, 480);
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed-37.5;
            CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
          ...
          case 17:
          {
            ...
            ucMotorState = 0;
            distanceCorrection = 2.45;
            move(0);
            break;
          }
          case 18:
          {
            ENC_SetDistance(-45, 45);
            CR1_ui8LeftWheelSpeed = 250;
            CR1_ui8RightWheelSpeed = 250;
          ...
          case 20:
          {
            ledcWrite(7, configureMotor(180));
            ucMotorState = 0;
            move(0);
            break;
         }
    ...
    case 1: 
    {
      //read pot 1 for motor speeds 
        // adjust to range that will produce motion
...
long configureMotor(int deg){
  const long minDuty = 1675;
  const long maxDuty = 8000;
  long dutyCycle;

  dutyCycle = map(deg, 0, 180, minDuty, maxDuty);
