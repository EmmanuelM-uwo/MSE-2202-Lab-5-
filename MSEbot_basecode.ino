       ...
       {   
         ...
         switch(ucMotorStateIndex)
         {
           ...
           case 1:
          {
            ...
            ENC_SetDistance(828.57, 887.6);
            ucMotorState = 1;   //forward
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed-42.55;
           ...
           case 2:
          {
            ucMotorStateIndex = 3;
            ucMotorState = 0;
            distanceCorrection = 3.625;
            move(0);
            break;
          }
          case 3:
          {
            ENC_SetDistance(414, 434);
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed-39.0;
            CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
            ucMotorStateIndex = 4;
